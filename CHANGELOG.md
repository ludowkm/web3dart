...
- Add `package:web3dart_avacus/browser.dart`, a library for using this package in
...
- Add the `package:web3dart_avacus/contracts/erc20.dart` library for interacting with an
...
| Low-level cryptographic operations like signing, hashing and converting hex <-> byte array <-> integer  | Not available in the core library. Import `package:web3dart_avacus/crypto.dart` instead |
